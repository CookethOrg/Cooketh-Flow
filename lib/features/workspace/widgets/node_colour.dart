...
class NodeColourPicker extends StatelessWidget {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                _buildModeButton('Fill', PhosphorIconsRegular.square, color: Colors.black),
                const SizedBox(width: 8),
                _buildModeButton('Transparent', PhosphorIconsFill.square, color: const Color.fromARGB(88, 0, 0, 0)),
                const SizedBox(width: 8),
                _buildModeButton('No Fill', PhosphorIconsFill.square, color: Colors.black),
              ],
            ),
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: tertiaryColors.asMap().entries.map((entry) {
                    ...
                    bool isSelected = entry.key == 3; // Light Purple is selected
                    return _buildColorBox(color, isSelected: isSelected);
                  }).toList(),
                ),
              ],
            ),
  ...
  Widget _buildModeButton(String text, IconData icon, {Color color = Colors.black}) {
    bool isSelected = text == 'Fill'; // Hardcode "Fill" as selected
    return Container(
