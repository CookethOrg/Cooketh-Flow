...
class _CustomPointerState extends State<CustomPointer> {
  ...
  Widget build(BuildContext context) {
    return Consumer<WorkspaceProvider>(builder: (context, workProvider, child) {
      return MouseRegion(
  ...
  void _checkInteractiveElements(Offset globalPosition, BuildContext context,
    ...
    if (wasOverInteractive != _isOverInteractive &&
        widget.onClickable != null) {
  ...
  bool _isDrawerAt(
      Offset position, BuildContext context, WorkspaceProvider workProvider) {
